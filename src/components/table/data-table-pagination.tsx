...
export function DataTablePagination<TData>({
	...
	return (
		<div className="flex flex-col xs:flex-row items-center justify-end px-2 space-x-6 lg:space-x-8 my-1">
			...
			<div className="flex">
				...
				<div className="flex w-[100px] items-center justify-center text-sm font-medium sm:hidden break-words">
